<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="AssetsExpProjHistory.aspx.vb" Inherits="EXP_AssetsExpProjHistory"
    Title="Untitled Page" %>
                                ...
                                <tr>
                                    ...
                                    <td valign="middle">
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:HyperLink ID="lnkCommBoad" runat="server" NavigateUrl='<%# GoToCommBoard(DataBinder.Eval(Container, "DataItem.ProjectNo"), DataBinder.Eval(Container, "DataItem.ActionDesc")) %>'
                                                        ImageUrl="~/images/messanger30.jpg" Visible='<%#  ShowHideLink(DataBinder.Eval(Container, "DataItem.ActionDesc")) %>' />
                                                </td>
                                                <td>
                                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# GoToCommBoard(DataBinder.Eval(Container, "DataItem.ProjectNo"), DataBinder.Eval(Container, "DataItem.ActionDesc")) %>'
