        ...
        If ViewState("pProjNo") <> "" Then
            Try
                ...
                If Session("TempCrystalRptFiles") Is Nothing Then
                    ...
                    'oRpt.SetParameterValue("@SoldTo", 0)
                    oRpt.SetParameterValue("@ProgramID", 0)
                    oRpt.SetParameterValue("@AcctMgrTMID", 0)
                    oRpt.SetParameterValue("@PrgmMgrTMID", 0)
                    oRpt.SetParameterValue("@ToolLeadTMID", 0)
                    oRpt.SetParameterValue("@PurchLeadTMID", 0)
                    oRpt.SetParameterValue("@ProjectType", "")
                    ...
                    Response.Charset = ""
                    Response.AddHeader("content-disposition", "inline;filename=CapEx Tooling-" & ViewState("pProjNo").ToString & "preview.pdf")
