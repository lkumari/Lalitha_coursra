' ************************************************************************************************
' Name:	DevelopmentExpProjHistory.aspx.vb
...
' ************************************************************************************************
Partial Class EXP_DevelopmentExpProjHistory
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            m.ContentLabel = "Development Project History"
            ...
            If ctl IsNot Nothing Then
                ...
                lbl.Text = "<a href='../Home.aspx'><b>Home</b></a> > <b>Spending Requests</b> > <a href='DevelopmentExpProjList.aspx'><b>Development Project Search</b></a> > History"
                lbl.Visible = True
            End If
    ...
    Private Sub BindData()
        ...
        Try
            ...
            ds = EXPModule.GetDevelopmentExpProjHistory(ViewState("pProjNo"))
...
#End Region 'EOF Paging Routine
    ...
    Public Function GoToCommBoard(ByVal ProjectNo As String, ByVal ActionDesc As String) As String
        If ActionDesc = "Message Sent" Then
            Return "DevelopmentExpProj.aspx?pProjNo=" & ProjectNo & "&pRC=1"
        Else
            Return ""
        End If
