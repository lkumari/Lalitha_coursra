<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="AssetsExpProj.aspx.vb" Inherits="EXP_AssetsExpProj" Title="Untitled Page"
        ...
        <table width="100%">
            <tr>
                ...
                <td style="color: #990000; width: 100px;">
                    <asp:Label ID="lblProjectID" runat="server" Text="A0000" CssClass="c_text" Font-Bold="True"
            ...
            <%--Display the following rows after 'A' is voided.--%>
            <tr>
                ...
                <td colspan="3" style="width: 30px">
                    <asp:Menu ID="mnuTabs" Height="30px" runat="server" Orientation="Horizontal" StaticEnableDefaultPopOutImage="false"
                        ...
                        <Items>
                            ...
                            <asp:MenuItem Text="Assets" Value="1" ImageUrl="" />
        ...
        <asp:MultiView ID="mvTabs" runat="server" Visible="true" ActiveViewIndex="0" EnableViewState="true">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txtHDUGNLocation" runat="server" Visible="False" Width="20px" />
                        </td>
                        <td class="p_text">
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txtHDDepartment" runat="server" Visible="False" Width="20px" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <asp:Label ID="lblJustification" runat="server" Font-Bold="True" ForeColor="Red" />&nbsp;<asp:TextBox
                                ID="txtAnalysis" runat="server" MaxLength="2000" Rows="8" TextMode="MultiLine"
                    ...
                    <% End If%>
                    <% If (ViewState("pProjNo") <> Nothing) And (ViewState("ProjectStatus") <> "Open") Then%>
                    <tr>
                        <td colspan="2">
                            &nbsp;
                        </td>
                        <td colspan="2">
                            ...
                            <asp:Label ID="lblEstCmpltDtChange" runat="server" Text="Change Reason:" Visible="false"
                                ForeColor="Red" />
                            <asp:TextBox ID="txtEstCmpltDtChngRsn" Width="400px" runat="server" />
            ...
            <asp:View ID="vwAssetExpense" runat="server">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvCategory" runat="server" ControlToValidate="ddCategory"
                                    ErrorMessage="Category is a required field." ValidationGroup="vsAssetsExpense"><</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="p_text">
                            ...
                            <td>
                                <asp:DropDownList ID="ddCapitalSpending" runat="server" />
                                <asp:RequiredFieldValidator ID="rfvCSCode" runat="server" ControlToValidate="ddCapitalSpending"
                                    ErrorMessage="Capital Spending is a required field." ValidationGroup="vsAssetsExpense"><</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="p_text">
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvDescription" runat="server" ControlToValidate="txtDescription"
                                    ErrorMessage="Description is a required field." ValidationGroup="vsAssetsExpense"><</asp:RequiredFieldValidator><br />
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvQuantity" runat="server" ControlToValidate="txtQuantity"
                                    ErrorMessage="Quantity is a required field." ValidationGroup="vsAssetsExpense"><</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="p_text">
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvAmountPer" runat="server" ControlToValidate="txtAmountPer"
                                    ErrorMessage="Amount Per ($) is a required field." ValidationGroup="vsAssetsExpense"><</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="p_text" valign="top">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnAddtoGrid2" runat="server" Text="Save" CommandName="AddtoGrid2"
                                    ToolTip="Add to grid." ValidationGroup="vsAssetsExpense" />
                                <asp:Button ID="btnReset4" runat="server" Text="Reset" CausesValidation="False" />
                            </td>
                        </tr>
                    </table>
                    <asp:ValidationSummary ID="vsAssetsExpense" runat="server" Font-Size="X-Small" ShowMessageBox="True"
                        ShowSummary="true" ValidationGroup="vsAssetsExpense" />
                </asp:Panel>
                ...
                <asp:GridView ID="gvExpense" runat="server" AutoGenerateColumns="False" DataKeyNames="EID,ProjectNo"
                    ...
                    <Columns>
                        <asp:BoundField DataField="EID" HeaderText="Asset Line #" SortExpression="EID" ItemStyle-HorizontalAlign="center">
                        ...
                        <asp:TemplateField HeaderText="Category" SortExpression="CategoryName" HeaderStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                ...
                                <asp:HyperLink ID="lblCategory" runat="server" Font-Underline="true" Text='<%# Bind("CategoryName") %>'
                                    NavigateUrl='<%# "AssetsExpProj.aspx?pEID=" & DataBinder.Eval (Container.DataItem,"EID").tostring & "&pProjNo=" & ViewState("pProjNo")%>' />
                                <% Else%>
                                <asp:Label ID="lblCategory1" runat="server" Text='<%# Bind("CategoryName") %>' />
                                <% End If%>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle Width="200px" Wrap="True" />
                        </asp:TemplateField>
                        <asp:BoundField DataField="GLNo" HeaderText="General Ledger #" SortExpression="GLNo"
                            ItemStyle-HorizontalAlign="center">
                            <ItemStyle Wrap="False" />
                        </asp:BoundField>
                        <asp:BoundField DataField="UsefulLife" HeaderText="Useful Life in #Years" SortExpression="UsefulLife"
                            ItemStyle-HorizontalAlign="center">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="CapitalSpendingName" HeaderText="Capital Classification"
                            SortExpression="CapitalSpendingName" HeaderStyle-HorizontalAlign="Left">
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle Wrap="False" />
                            <ItemStyle Width="200px" Wrap="True" />
                        </asp:BoundField>
                ...
                <asp:ObjectDataSource ID="odsExpense" runat="server" DeleteMethod="DeleteExpProjAssetsExpenditure"
                    OldValuesParameterFormatString="original_{0}" SelectMethod="GetExpProjAssetsExpenditure"
                    TypeName="ExpProjAssetsBLL">
                    <DeleteParameters>
                ...
                <asp:Panel ID="SDContentPanel" runat="server" CssClass="collapsePanel" Width="800px">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="c_text">
                                <asp:DropDownList ID="ddAssetLineNo" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="p_text" valign="top">
                ...
                <asp:GridView ID="gvSupportingDocument" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="EID" HeaderText="Asset Line #" SortExpression="EID">
                        ...
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:HyperLink runat="server" ID="hlnkPreview" ImageUrl='<%# DisplayImage(DataBinder.Eval(Container, "DataItem.EncodeType").tostring)  %>'
                                    NavigateUrl='<%# "AssetsExpProjDocument.aspx?pProjNo=" & DataBinder.Eval (Container.DataItem,"ProjectNo").tostring & "&pDocID=" & DataBinder.Eval (Container.DataItem,"DocID").tostring %>'
                ...
                <asp:ObjectDataSource ID="odsSupportingDocument" runat="server" DeleteMethod="DeleteExpProjAssetsDocuments"
                    OldValuesParameterFormatString="original_{0}" SelectMethod="GetExpProjAssetsDocuments"
                    TypeName="ExpProjAssetsBLL">
                    <DeleteParameters>
                        <asp:Parameter Name="ProjectNo" Type="String" />
                ...
                <table>
                    <tr>
                        ...
                        <td class="c_text" style="width: 243px; color: #990000;">
                            <b>
                                <asp:Label ID="lblSubtotalAssets" runat="server" Text="0.00" /></b>
                        </td>
                    </tr>
                    <tr>
                        <td class="p_text">
                    ...
                    <tr>
                        ...
                        <td class="c_text" style="width: 243px; color: #990000;">
                            <b>
                                <asp:Label ID="lblTotalInvestment1" runat="server" Text="0.00" /></b>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtStartupExpense" runat="server" Width="100px" MaxLength="12">0.00</asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtCustReimb" runat="server" Width="100px" MaxLength="12">0.00</asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtSalvageValue" runat="server" Width="100px" MaxLength="12">0.00</asp:TextBox>
                            <ajax:FilteredTextBoxExtender ID="ftbSalvageValue" runat="server" TargetControlID="txtSalvageValue"
                                FilterType="Custom, Numbers" ValidChars="-." />
                            <asp:RangeValidator ID="rvSalvageValue" runat="server" ControlToValidate="txtSalvageValue"
                                Display="Dynamic" ErrorMessage="Salvage Value requires a numeric value -999999999.99 to 999999999.99"
                                Height="16px" MaximumValue="999999999.99" MinimumValue="-999999999.99" Type="Double"
                                ValidationGroup="vsOtherExp"><</asp:RangeValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNetBookValue" runat="server" Width="100px" MaxLength="12">0.00</asp:TextBox>
                            <ajax:FilteredTextBoxExtender ID="ftbNetBookValue" runat="server" TargetControlID="txtNetBookValue"
                                FilterType="Custom, Numbers" ValidChars="-." />
                            <asp:RangeValidator ID="rvNetBookValue" runat="server" ControlToValidate="txtNetBookValue"
                                Display="Dynamic" ErrorMessage="Net Book Value requires a numeric value -999999999.99 to 999999999.99"
                                Height="16px" MaximumValue="999999999.99" MinimumValue="-999999999.99" Type="Double"
                                ValidationGroup="vsOtherExp"><</asp:RangeValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNetTaxValue" runat="server" Width="100px" MaxLength="12" ToolTip="For machinery/equipment greater than 8 years old, the NTV will be $0.">0.00</asp:TextBox>
                            <ajax:FilteredTextBoxExtender ID="ftbNetTaxValue" runat="server" TargetControlID="txtNetTaxValue"
                                FilterType="Custom, Numbers" ValidChars="-." />
                            <asp:RangeValidator ID="rvNetTaxValue" runat="server" ControlToValidate="txtNetTaxValue"
                                Display="Dynamic" ErrorMessage="Net Tax Value requires a numeric value -999999999.99 to 999999999.99"
                                Height="16px" MaximumValue="999999999.99" MinimumValue="-999999999.99" Type="Double"
                                ValidationGroup="vsOtherExp"><</asp:RangeValidator>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txtDiscountReturn" runat="server" Width="5px" MaxLength="3" Visible="False">0</asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="p_text">
                        ...
                        <td>
                            <asp:TextBox ID="txtRtnAvgAssets" runat="server" Width="60px" MaxLength="3">0</asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtRepairSavings" runat="server" Width="100px" MaxLength="12">0.00</asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtPayback" runat="server" Width="60px" MaxLength="3" Enabled="False">0</asp:TextBox>
            ...
            <asp:View ID="vwApprovalStatus" runat="server">
                ...
                <asp:ObjectDataSource ID="odsApprovers" runat="server" OldValuesParameterFormatString="original_{0}"
                    SelectMethod="GetExpProjAssetsApproval" TypeName="ExpProjAssetsBLL" UpdateMethod="UpdateExpProjAssetsApproval"
                    DeleteMethod="DeleteExpProjAssetsApproval" InsertMethod="InsertExpProjAssetsAddLvl1Aprvl">
                    <UpdateParameters>
            ...
            <asp:View ID="vwCommunicationBoard" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <asp:ObjectDataSource ID="odsReply" runat="server" OldValuesParameterFormatString="original_{0}"
                                            SelectMethod="GetExpProjAssetsRSSReply" TypeName="ExpProjAssetsBLL">
                                            <SelectParameters>
                                                <asp:QueryStringParameter Name="ProjectNo" QueryStringField="pProjNo" Type="String" />
                ...
                <asp:ObjectDataSource ID="odsQuestion" runat="server" OldValuesParameterFormatString="original_{0}"
                    SelectMethod="GetExpProjAssetsRSS" TypeName="ExpProjAssetsBLL">
                    <SelectParameters>
                        <asp:QueryStringParameter Name="ProjectNo" QueryStringField="pProjNo" Type="String" />
                        <asp:Parameter Name="RSSID" Type="Int32" DefaultValue="0" />
                    </SelectParameters>
