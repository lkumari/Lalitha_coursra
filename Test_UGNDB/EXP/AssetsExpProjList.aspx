<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="AssetsExpProjList.aspx.vb" Inherits="EXP_AssetsExpProjList" Title="Untitled Page" %>
    ...
    <asp:Panel ID="localPanel" runat="server" Width="1000px" DefaultButton="btnSearch">
            ...
            <tr>
                ...
                <td class="c_textbold" style="color: red;" colspan="3">
                    <asp:DropDownList ID="ddProjectStatus" runat="server">
                        ...
                        <asp:ListItem Value="HHold">Hold</asp:ListItem>
        ...
        <table id="TABLE1" width="100%">
            <tbody>
                ...
                <tr>
                    <td colspan="12">
                        &nbsp;<asp:Repeater ID="rpAssetsExpProj" runat="server">
                            <SeparatorTemplate>
                                <tr>
                                    <td colspan="12">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <asp:HyperLink ID="getData" Font-Underline="true" runat="server" NavigateUrl='<%# "AssetsExpProj.aspx?pProjNo=" & DataBinder.Eval (Container.DataItem,"ProjectNo").tostring & "&pPrntProjNo=" &  DataBinder.Eval (Container.DataItem,"ParentProjectNo").tostring %>'>
                                 <%#DataBinder.Eval(Container, "DataItem.ProjectNo")%>
                                    ...
                                    <td align="center">
                                        <asp:HyperLink ID="lnkPreview" runat="server" NavigateUrl='<%# "crViewExpProjAssets.aspx?pProjNo=" & DataBinder.Eval (Container.DataItem,"ProjectNo").tostring %>'
                                            Target="_blank" ImageUrl="~/images/PreviewUp.jpg"></asp:HyperLink>
                                    </td>
                                    <td align="center">
                                        <asp:HyperLink ID="lnkHistory" runat="server" NavigateUrl='<%# "AssetsExpProjHistory.aspx?pProjNo=" & DataBinder.Eval (Container.DataItem,"ProjectNo").tostring  %>'
