...
'
' Date		    Author	    
' 03/02/2010    LRey			Created .Net application
' 04/02/2012    LRey            Modified to use .NET Mail process; Consolidated Email Body; Modified forward to include TM's at same level after a rejection.
' 05/06/2013    LRey            Modified the security to allow Eddie Webb to enter Tinley Park 1st level approval
' ************************************************************************************************
Partial Class EXP_AssetsExpProj
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            ''Used for Asset Expense binddata and update
            ...
            ''Used to take user back to Asset Expense Tab after reset/save
            ...
            m.PageTitle = "UGN, Inc."
            If ViewState("pProjNo") = Nothing Then
                m.ContentLabel = "New Property Plant Equipment (Asset)"
            Else
                m.ContentLabel = "Property Plant Equipment (Asset)"
            End If
            ...
            If ctl IsNot Nothing Then
                ...
                If ViewState("pProjNo") = Nothing Then
                    lbl.Text = "<a href='../Home.aspx'><b>Home</b></a> > <b>Spending Requests</b> > <a href='AssetsExpProjList.aspx'><b>Property Plant Equipment (Asset) Search</b></a> > New Property Plant Equipment (Asset)"
                Else
                    If ViewState("pAprv") = 0 Then
                        lbl.Text = "<a href='../Home.aspx'><b>Home</b></a> > <b>Spending Requests</b> > <a href='AssetsExpProjList.aspx'><b>Property Plant Equipment (Asset) Search</b></a> > Property Plant Equipment (Asset)"
                    Else 'Go Back To approval Screen
                        lbl.Text = "<a href='../Home.aspx'><b>Home</b></a> > <b>Spending Requests</b> > <a href='AssetsExpProjList.aspx'><b>Property Plant Equipment (Asset) Search</b></a> > <a href='crExpProjAssetsApproval.aspx?pProjNo=" & ViewState("pProjNo") & "&pAprv=1'><b>Approval</b></a> > Property Plant Equipment (Asset)"
                    End If
                End If
                lbl.Visible = True
            End If
            ...
            Dim strPreviewClientScript As String = "javascript:void(window.open('crViewExpProjAssets.aspx?pProjNo=" & ViewState("pProjNo") & "'," & Now.Ticks.ToString & ",'top=5,left=5,resizable=yes,status=no,toolbar=no,scrollbars=yes,menubar=no,location=yes'));"
...
#Region "Form Level Security using Roles &/or Subscriptions"
    Protected Sub CheckRights()
        ...
        Try
            ...
            gvExpense.Columns(10).Visible = False
            ...
            If txtHDEstCmpltDt.Text.Trim <> "" And txtNextEstCmpltDt.Text.Trim <> "" And (ViewState("ProjectStatus") <> "Open") Then
            ...
            Else
                rfvEstCmpltDtChngRsn.Enabled = False
                txtEstCmpltDtChngRsn.Enabled = False
                txtEstCmpltDtChngRsn.Visible = False
            End If
            ...
            Dim iFormID As Integer = 101 'Property Plant Equipment Form ID
            Dim iRoleID As Integer = 0
            Dim i As Integer = 0

            dsTeamMember = SecurityModule.GetTeamMember(Nothing, strFullName, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing)
            ''dsTeamMember = SecurityModule.GetTeamMember(Nothing, "Steve.Nash", Nothing, Nothing, Nothing, Nothing, Nothing, Nothing)
                                    ...
                                    Select Case iRoleID
                                        Case 11 '*** UGNAdmin: Full Access
                                            ...
                                            Else
                                                ...
                                                gvExpense.Columns(10).Visible = True
                                        ...
                                        Case 12 '*** UGNChampion: Create/Edit/Delete (Begins Process)
                                            ...
                                            If txtRoutingStatus.Text <> "C" Then
                                                'And ddProjectLeader.SelectedValue = ViewState("iTeamMemberID") Then
                                                btnSave1.Enabled = True
                                                btnReset1.Enabled = True
                                            End If
                                            ''*************************************************
                                            ...
                                            If ViewState("pProjNo") = Nothing Or ViewState("pProjNo") = "" Then
                                                ...
                                                txtProjectTitle.Focus()
                                            Else
                                                'If ddProjectLeader.SelectedValue = ViewState("iTeamMemberID") Then
                                                ViewState("Admin") = True
                                                Select Case ProjectStatus
                                                    ...
                                                    Case "In Process"
                                                        ...
                                                        If (txtRoutingStatus.Text = "R" Or txtRoutingStatus.Text = "S") Then
                                                            ...
                                                            btnSave2.Enabled = True
                                                            btnReset5.Enabled = True
                                                        ElseIf txtRoutingStatus.Text = "H" Then
                                                            btnFwdApproval.Enabled = True
...
#Region "General - Project Detail"
    Protected Sub BindCriteria()
        Try
            ...
            ds = EXPModule.GetExpProjCategory("")
            If (ds.Tables.Item(0).Rows.Count > 0) Then
                ddCategory.DataSource = ds
                ddCategory.DataTextField = ds.Tables(0).Columns("ddCategoryName").ColumnName.ToString()
                ddCategory.DataValueField = ds.Tables(0).Columns("CategoryID").ColumnName.ToString()
                ddCategory.DataBind()
                ddCategory.Items.Insert(0, "")
            End If

            ''bind existing data to drop down Capital Classification control for selection criteria for search
            ds = EXPModule.GetExpProjCapitalSpending("")
            If (ds.Tables.Item(0).Rows.Count > 0) Then
                ddCapitalSpending.DataSource = ds
                ddCapitalSpending.DataTextField = ds.Tables(0).Columns("ddCapitalSpendingName").ColumnName.ToString()
                ddCapitalSpending.DataValueField = ds.Tables(0).Columns("CSCode").ColumnName.ToString()
                ddCapitalSpending.DataBind()
                ddCapitalSpending.Items.Insert(0, "")
            End If

            ''bind existing data to drop down Asset Line # control for selection criteria for search
            ds = EXPModule.GetExpProjAssetsExpenditure(ViewState("pProjNo"), 0)
            If (ds.Tables.Item(0).Rows.Count > 0) Then
                ddAssetLineNo.DataSource = ds
                ddAssetLineNo.DataTextField = ds.Tables(0).Columns("EID").ColumnName.ToString()
                ddAssetLineNo.DataValueField = ds.Tables(0).Columns("EID").ColumnName.ToString()
                ddAssetLineNo.DataBind()
                ddAssetLineNo.Items.Insert(0, "")
            End If
    ...
    Public Sub BindData(ByVal ProjNo As String)
        ...
        Try
            If ProjNo <> Nothing Then
                ds = EXPModule.GetExpProjAssets(ProjNo, "", "", "", 0, "", 0, "", "")
                If commonFunctions.CheckDataSet(ds) = True Then
                    ...
                    txtHDUGNLocation.Text = ds.Tables(0).Rows(0).Item("UGNFacility").ToString()
                    cddDepartment.SelectedValue = ds.Tables(0).Rows(0).Item("DeptOrCostCenter").ToString()
                    txtHDDepartment.Text = ds.Tables(0).Rows(0).Item("DeptOrCostCenter").ToString()
                    ...
                    txtAnalysis.Text = ds.Tables(0).Rows(0).Item("Analysis").ToString()
                    ...
                    If IsDBNull(ds.Tables(0).Rows(0).Item("CRProjectNo").ToString()) _
                    Or ds.Tables(0).Rows(0).Item("CRProjectNo").ToString() = "" _
                    Or ds.Tables(0).Rows(0).Item("CRProjectNo").ToString() = Nothing Then
                    ...
                    lblSubtotalAssets.Text = Format(ds.Tables(0).Rows(0).Item("TotalInv"), "#,##0.00")

                    txtHDTotalInvestment.Text = Format(IIf(ds.Tables(0).Rows(0).Item("OrigTotalInv") IsNot System.DBNull.Value, ds.Tables(0).Rows(0).Item("OrigTotalInv"), 0))
                    ''Format(ds.Tables(0).Rows(0).Item("OrigTotalInv"), "#,##0.00")
                    lblTotalInvestment.Text = Format(((lblSubtotalAssets.Text - txtLessRtrdEqVal.Text) + txtWorkingCapital.Text), "#,##0.00")
                    lblTotalInvestment1.Text = Format(((lblSubtotalAssets.Text - txtLessRtrdEqVal.Text) + txtWorkingCapital.Text), "#,##0.00")
                    cbProjectInLatestForecast.Checked = ds.Tables(0).Rows(0).Item("ProjectInLatestForecast").ToString()
                    txtSalvageValue.Text = ds.Tables(0).Rows(0).Item("SalvageValue").ToString()
                    txtNetBookValue.Text = ds.Tables(0).Rows(0).Item("NetBookValue").ToString()
                    txtNetTaxValue.Text = ds.Tables(0).Rows(0).Item("NetTaxValue").ToString()
                    ...
                    Dim CalcSavings As Decimal = ds.Tables(0).Rows(0).Item("RepairSavings") + ds.Tables(0).Rows(0).Item("ScrapSavings") + ds.Tables(0).Rows(0).Item("ConsumableSavings") + ds.Tables(0).Rows(0).Item("LaborSavings") + ds.Tables(0).Rows(0).Item("OtherSavings")
                    If ds.Tables(0).Rows(0).Item("PaybackInYears") = 0 Then
                        If lblTotalInvestment1.Text <> 0 And CalcSavings <> 0 Then
                            txtPayback.Text = ((lblSubtotalAssets.Text - txtLessRtrdEqVal.Text) + txtWorkingCapital.Text) / CalcSavings
                        Else
                            txtPayback.Text = 0
                        End If
                    Else
                ...
                ''Bind Expenses
                If ViewState("pEID") <> 0 Then
                    ds = EXPModule.GetExpProjAssetsExpenditure(ViewState("pProjNo"), ViewState("pEID"))
                    If commonFunctions.CheckDataSet(ds) = True Then
                        ddCategory.SelectedValue = ds.Tables(0).Rows(0).Item("CategoryID").ToString()
                        ddCapitalSpending.SelectedValue = ds.Tables(0).Rows(0).Item("CSCode").ToString()
                    ...
                    Else 'no record found reset query string pRptID
                        Response.Redirect("AssetsExpProj.aspx?pProjNo=" & ViewState("pProjNo") & "&pEID=0", False)
                    End If
                End If

                ''Bind Communication Board
                If ViewState("pRID") <> 0 Then
                    ds = EXPModule.GetAssetsExpProjRSS(ViewState("pProjNo"), ViewState("pRID"))
                    If commonFunctions.CheckDataSet(ds) = True Then
                        txtQC.Text = ds.Tables(0).Rows(0).Item("Comments").ToString()
                    Else 'no record found reset query string pRptID
                        Response.Redirect("AssetsExpProj.aspx?pProjNo=" & ViewState("pProjNo") & "&pRID=0&pRC=1", False)
                    End If
                End If

                ''Make Cost Reduction Ref# a required field.
                Dim i As Integer = 0
                ds = EXPModule.GetExpProjAssetsExpenditure(ViewState("pProjNo"), 0)
                If commonFunctions.CheckDataSet(ds) = True Then
                    For i = 0 To ds.Tables.Item(0).Rows.Count - 1
                        If ds.Tables(0).Rows(i).Item("CSCode") = "C" Then
                            lblReqCRProjNo.Visible = True
                            rfvCRProjNo.Visible = True
                        Else
                            lblReqCRProjNo.Visible = False
                            rfvCRProjNo.Visible = False
                        End If
                    Next i
                End If
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Response.Redirect("AssetsExpProj.aspx", False)
    ...
    Protected Sub btnAppend_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAppend.Click
        Response.Redirect("AssetsExpProj.aspx?pProjNo=&pPrntProjNo=" & ViewState("pProjNo"), False)
        ...
        Try
            ...
            If (ViewState("pProjNo") <> Nothing Or ViewState("pProjNo") <> "") Then
                ...
                If ddProjectStatus.SelectedValue = "Capitalized" And txtRoutingStatus.Text = "C" Then
                    ...
                    ''History Tracking
                    ''*****************
                    EXPModule.InsertExpProjAssetsHistory(ViewState("pProjNo"), txtProjectTitle.Text, DefaultTMID, "Capitalized", "", "", "", "")
                    If txtRoutingStatus.Text <> "N" Then
                ...
                ElseIf ddProjectStatus.SelectedValue = "Completed" Then
                    ...
                    ''History Tracking
                    ''*****************
                    EXPModule.InsertExpProjAssetsHistory(ViewState("pProjNo"), txtProjectTitle.Text, DefaultTMID, "Completed", "", "", "", "")
                ...
                ElseIf ddProjectStatus.SelectedValue = "Void" And txtRoutingStatus.Text = "V" Then
                    ...
                    ''History Tracking
                    ''*****************
                    EXPModule.InsertExpProjAssetsHistory(ViewState("pProjNo"), txtProjectTitle.Text, DefaultTMID, "VOID - Reason:" & txtVoidReason.Text, "", "", "", "")
                    If txtRoutingStatus.Text <> "N" Then
            ...
            Else 'New Record
                ...
                ds = EXPModule.GetNextExpProjectNo(ViewState("pPrntProjNo"), ddUGNLocation.SelectedValue, "Assets")
                ...
                '* Save Data
                '***************
                EXPModule.InsertExpProjAssets(ViewState("pProjNo"), ViewState("pPrntProjNo"), txtProjectTitle.Text, ddProjectStatus.SelectedValue, UGNLocation, ddProjectLeader.SelectedValue, txtProjDateNotes.Text, txtJustification.Text, txtAnalysis.Text, txtDateSubmitted.Text, txtEstCmpltDt.Text, txtEstSpendDt.Text, txtEstEndSpendDt.Text, lblPrntAppDate.Text, Department, cbProjectInLatestForecast.Checked, DefaultUser, DefaultDate)

                ''*****************
                ''History Tracking
                ''*****************
                EXPModule.InsertExpProjAssetsHistory(ViewState("pProjNo"), txtProjectTitle.Text, DefaultTMID, "Record created.", "", "", "", "")
                ...
                If ViewState("pAprv") = 1 Then
                    Aprv = "&pAprv=1"
                End If
                Response.Redirect("AssetsExpProj.aspx?pProjNo=" & ViewState("pProjNo") & "&pPrntProjNo=" & ViewState("pPrntProjNo") & Aprv, False)
            End If
        Catch ex As Exception
            'update error on web page
            lblErrors.Text = ex.Message
    ...
    Public Function UpdateRecord(ByVal ProjectStatus As String, ByVal RoutingStatus As String, ByVal RecSubmitted As Boolean) As String
        Try
            ...
            Dim EstCmpltDt As String = Nothing
            ...
            If txtHDEstCmpltDt.Text <> txtNextEstCmpltDt.Text Then
                ...
                txtEstCmpltDtChngRsn.Visible = False
            Else
                EstCmpltDt = txtHDEstCmpltDt.Text
                rfvEstCmpltDt.Enabled = False
            End If
            ...
            '* Update Data
            '***************
            EXPModule.UpdateExpProjAssets(ViewState("pProjNo"), txtProjectTitle.Text, ProjectStatus, UGNLocation, ddProjectLeader.SelectedValue, txtProjDateNotes.Text, txtJustification.Text, txtAnalysis.Text, IIf(RecSubmitted = False, txtDateSubmitted.Text, DefaultDate), EstCmpltDt, txtEstSpendDt.Text, txtEstEndSpendDt.Text, RoutingStatus, txtActualCost.Text, txtCustomerCost.Text, txtClosingNotes.Text, txtVoidReason.Text, Department, IIf(txtLessRtrdEqVal.Text = "", 0, txtLessRtrdEqVal.Text), IIf(txtWorkingCapital.Text = "", 0, txtWorkingCapital.Text), IIf(txtStartupExpense.Text = "", 0, txtStartupExpense.Text), IIf(txtCustReimb.Text = "", 0, txtCustReimb.Text), cbNotRequired.Checked, IIf(txtPayback.Text = "", 0, CType(txtPayback.Text.Trim, Double)), IIf(txtRtnAvgAssets.Text = "", 0, txtRtnAvgAssets.Text), cbProjectInLatestForecast.Checked, IIf(txtSalvageValue.Text = "", 0, txtSalvageValue.Text), IIf(txtNetBookValue.Text = "", 0, txtNetBookValue.Text), IIf(txtNetTaxValue.Text = "", 0, txtNetTaxValue.Text), IIf(txtRepairSavings.Text = "", 0, txtRepairSavings.Text), IIf(txtScrapSavings.Text = "", 0, txtScrapSavings.Text), IIf(txtConsumableSavings.Text = "", 0, txtConsumableSavings.Text), IIf(txtLaborSavings.Text = "", 0, txtLaborSavings.Text), IIf(txtOtherSavings.Text = "", 0, txtOtherSavings.Text), IIf(ddCRProjNo.SelectedValue = "", 0, ddCRProjNo.SelectedValue), DefaultUser, DefaultDate)
    ...
    Protected Sub btnReset1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset1.Click, btnReset4.Click, btnReset5.Click, btnReset6.Click
        ...
        If mnuTabs.Items(1).Selected = True Then
            parmVal = "&pEV=1"
        End If
        If mnuTabs.Items(3).Selected = True Then
            parmVal = "&pRC=1"
        End If
        ...
        If ViewState("pProjNo") <> "" Then
            If ViewState("pEID") > 0 Then
                Response.Redirect("AssetsExpProj.aspx?pProjNo=" & ViewState("pProjNo") & parmVal & Aprv, False)
            ElseIf ViewState("pRID") > 0 Then
                Response.Redirect("AssetsExpProj.aspx?pProjNo=" & ViewState("pProjNo") & parmVal & Aprv, False)
            ElseIf ViewState("pSD") > 0 Then
                Response.Redirect("AssetsExpProj.aspx?pProjNo=" & ViewState("pProjNo") & parmVal & Aprv, False)
    ...
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        Try
            ...
            '***************
            If ViewState("pPrntProjNo") = Nothing Then
                EXPModule.DeleteExpProjAssets(ViewState("pProjNo"), ViewState("pPrntProjNo"), False)
            Else
                EXPModule.DeleteExpProjAssets(ViewState("pProjNo"), ViewState("pPrntProjNo"), True)
            End If

            '***************
            '* Redirect user back to the search page.
            '***************
            Response.Redirect("AssetsExpProjList.aspx", False)
    ...
    '    Try
    '        Dim TodaysDate As Date = CType(Date.Now, Date)
    ...
    '            HDEstCmpltDt = txtHDEstCmpltDt.Text
    '        End If
    '        If HDEstCmpltDt <> NextEstCmpltDt Then 'And (CType(txtNextEstCmpltDt.Text, Date) > txtHDEstCmpltDt.Text)
    '            rfvEstCmpltDt.Enabled = False
    '            lblReqEstCmpltDtChange.Visible = True
    '            lblEstCmpltDtChange.Visible = True
    '            txtEstCmpltDtChngRsn.Visible = True
...
#Region "Asset Expense"
        ...
        Try
            If ViewState("pProjNo") <> Nothing Then
                ...
                If ViewState("pEID") = 0 Or ViewState("pEID") = Nothing Then
                    ...
                    '***************
                    EXPModule.InsertExpProjAssetsExpenditure(ViewState("pProjNo"), ddCategory.SelectedValue, ddCapitalSpending.SelectedValue, txtDescription.Text, IIf(txtQuantity.Text = "", 0, txtQuantity.Text), IIf(txtAmountPer.Text = "", 0, txtAmountPer.Text), txtNotes.Text, DefaultUser)

                    ddCategory.SelectedValue = Nothing
                    ddCapitalSpending.SelectedValue = Nothing
                ...
                Else
                    ...
                    '***************
                    EXPModule.UpdateExpProjAssetsExpenditure(ViewState("pEID"), ViewState("pProjNo"), ddCategory.SelectedValue, ddCapitalSpending.SelectedValue, txtDescription.Text, IIf(txtQuantity.Text = "", 0, txtQuantity.Text), IIf(txtAmountPer.Text = "", 0, txtAmountPer.Text), txtNotes.Text, DefaultUser)

                    Response.Redirect("AssetsExpProj.aspx?pProjNo=" & ViewState("pProjNo") & "&pEV=1", False)
                End If
    ...
    Protected Sub btnReset3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset3.Click
        ...
        Response.Redirect("AssetsExpProj.aspx?pProjNo=" & ViewState("pProjNo") & "&pEV=1" & Aprv, False)
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If imgBtn IsNot Nothing Then
                ...
                If db.CommandName = "Delete" Then
                    Dim price As ExpProjAssets.ExpProj_Assets_ExpenditureRow = CType(CType(e.Row.DataItem, System.Data.DataRowView).Row, ExpProjAssets.ExpProj_Assets_ExpenditureRow)
...
#Region "Communication Board"
    Public Function GoToCommunicationBoard(ByVal ProjectNo As String, ByVal RSSID As String, ByVal ApprovalLevel As Integer, ByVal TeamMemberID As Integer) As String
        ...
        If ViewState("pAprv") = 1 Then
            Aprv = "&pAprv=1"
        End If
        Return "AssetsExpProj.aspx?pProjNo=" & ProjectNo & "&pAL=" & ApprovalLevel & "&pTMID=" & TeamMemberID & "&pRID=" & RSSID & "&pRC=1" & Aprv
    ...
    Protected Sub btnSave2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave2.Click
        Try
            ...
            If CurrentEmpEmail <> Nothing And ViewState("pProjNo") <> Nothing Then
                ...
                ''***************************************************************
                ds = EXPModule.GetAssetsExpProjApproval(ViewState("pProjNo"), 0, TMID, False, False)
                ...
                If EmailTO <> Nothing Then
                    ...
                    ''***************************************************************
                    ds2CC = EXPModule.GetAssetsExpProjApproval(ViewState("pProjNo"), SeqNo, TMID, False, False)
                    ''Check that the recipient(s) is a valid Team Member
                    ...
                    MyMessage.Subject &= "Property Plant Equipment (Asset): " & ViewState("pProjNo") & " - " & txtProjectTitle.Text & " - MESSAGE RECIEVED"
                    ...
                    MyMessage.Body &= "         </p>"
                    MyMessage.Body &= "         <p><a href='" & ViewState("strProdOrTestEnvironment") & "/EXP/crExpProjAssetsApproval.aspx?pProjNo=" & ViewState("pProjNo") & "&pAprv=1" & "'>Click here</a> to return to the approval page."
                    MyMessage.Body &= "     </td>"
                    MyMessage.Body &= " </tr>"
                    ...
                    ''History Tracking
                    ''*****************
                    EXPModule.InsertExpProjAssetsHistory(ViewState("pProjNo"), txtProjectTitle.Text, DefaultTMID, "Message Sent", "", "", "", "")

                    ''**********************************
                    ''Save Reponse to child table
                    ''**********************************
                    EXPModule.InsertExpProjAssetsRSSReply(ViewState("pProjNo"), ViewState("pRID"), txtProjectTitle.Text, DefaultTMID, txtReply.Text)
                    ...
                    If uploadFile.PostedFile.ContentLength <= 3500000 Then
                        ...
                        If (FileExt = ".pdf") Or (FileExt = ".xls") Or (FileExt = ".doc") Or (FileExt = ".xlsx") Or (FileExt = ".docx") Then
                            ...
                            Else
                                ...
                                '' Insert Record
                                ''***************
                                EXPModule.InsertExpProjAssetsDocuments(ViewState("pProjNo"), ddTeamMember.SelectedValue, txtFileDesc.Text, SupportingDocBinaryFile, uploadFile.FileName, SupportingDocEncodeType, SupportingDocFileSize, IIf(ddAssetLineNo.SelectedValue = "", 0, ddAssetLineNo.SelectedValue), 0, "", "")
                            End If

                            gvSupportingDocument.DataBind()
                            revUploadFile.Enabled = False
                            txtFileDesc.Text = Nothing
                            ddAssetLineNo.SelectedValue = Nothing
                        End If
                    Else
    ...
    Protected Sub gvSupportingDocument_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvSupportingDocument.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If imgBtn IsNot Nothing Then
                ...
                ' Get information about the product bound to the row
                If db.CommandName = "Delete" Then
                    Dim price As ExpProjAssets.ExpProj_Assets_DocumentsRow = CType(CType(e.Row.DataItem, System.Data.DataRowView).Row, ExpProjAssets.ExpProj_Assets_DocumentsRow)
    ...
    Protected Sub gvSupportingDocument_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvSupportingDocument.RowCommand
        ...
        If e.CommandName = "Delete" Then
            ...
            If ViewState("pAprv") = 1 Then
                Aprv = "&pAprv=1"
            End If
            Response.Redirect("AssetsExpProj.aspx?pProjNo=" & ViewState("pProjNo") & "&pSD=1" & Aprv, False)
        End If
            ...
            If row IsNot Nothing Then
                ...
                If (t.Text <> "Pending") Then
                    If (c.Text <> Nothing Or c.Text <> "") Then
                        ...
                        ''History Tracking
                        ''*****************
                        EXPModule.InsertExpProjAssetsHistory(ViewState("pProjNo"), txtProjectTitle.Text, DefaultTMID, (DefaultUser.ToUpper) & " " & t.Text & " this record on behalf of " & ShortName.ToUpper & " - Comments: " & c.Text, "", "", "", "")
                        ...
                        If CurrentEmpEmail <> Nothing And ViewState("pProjNo") <> Nothing Then
                            ...
                            Else 'BUILD EMAIL
                                ''*******************************************************************
                                ''*Verify that atleast one Asset Expense Info entry is entered
                                ''*******************************************************************
                                Dim dsExp As DataSet = New DataSet
                                dsExp = EXPModule.GetExpProjAssetsExpenditure(ViewState("pProjNo"), 0)
                                If (dsExp.Tables.Item(0).Rows.Count = 0) Then 'If missing kick user out from submission.
                                    ...
                                    vsAssetsExpense.ShowSummary = True

                                    lblErrors.Text = "Atleast one Asset Expense entry is required for submission."
                                    lblErrors.Visible = True
                                    lblErrors.Font.Size = 12
                                    Exit Sub
                                Else
                                    ...
                                    ''***********************************
                                    EXPModule.UpdateExpProjAssetsApproval(ViewState("pProjNo"), TeamMemberID, True, t.SelectedValue, c.Text, SeqNo, 0, DefaultUser, DefaultDate)
                                    ...
                                    If t.SelectedValue = "Rejected" Or (SeqNo = 4 And t.SelectedValue = "Approved") Then
                                        ...
                                        If commonFunctions.CheckDataSet(dsRej) = True Then
                                            For i = 0 To dsRej.Tables.Item(0).Rows.Count - 1
                                                If (dsRej.Tables(0).Rows(i).Item("WorkStatus") = True) Or _
                                    ...
                                    If EmailTO <> Nothing Then
                                        ...
                                        If SeqNo > 1 Then
                                            ...
                                            ''**************************************************************
                                            EmailCC = CarbonCopyList(MyMessage, (NextLvl - 1), UGNLocation, 0, 0, EmailCC, DefaultTMID)
                                            If SeqNo = 4 Then
                                                ''**************************************************************
                                                ...
                                                ''**************************************************************
                                                EmailCC = CarbonCopyList(MyMessage, 0, UGNLocation, 2, 0, EmailCC, DefaultTMID)
                                                ''**************************************************************
                                                ''Carbon Copy 3rd Level Approvers
                                                ''**************************************************************
                                                EmailCC = CarbonCopyList(MyMessage, 0, UGNLocation, 3, 0, EmailCC, DefaultTMID)
                                                ''**************************************************************
                                                ''Carbon Copy 4th Level Approvers
                                                ''**************************************************************
                                                EmailCC = CarbonCopyList(MyMessage, 0, UGNLocation, 4, 0, EmailCC, DefaultTMID)
                                            End If
                                        Else
                                            If SeqNo = 1 Then
                                        ...
                                        MyMessage.Subject &= "Property Plant Equipment (Asset): " & ViewState("pProjNo") & " - " & txtProjectTitle.Text
                                        ...
                                        If t.SelectedValue <> "Rejected" Then
                                            If SeqNo = 4 Then
                                                EXPModule.InsertExpProjAssetsHistory(ViewState("pProjNo"), txtProjectTitle.Text, DefaultTMID, "Notification sent to all involved.", "", "", "", "")
                                            Else
                                                EXPModule.InsertExpProjAssetsHistory(ViewState("pProjNo"), txtProjectTitle.Text, DefaultTMID, "Notification sent to level " & IIf(SeqNo < 4, (SeqNo + 1), SeqNo) & " approver(s): " & EmpName, "", "", "", "")
                                            End If
                                        Else
                                            EXPModule.InsertExpProjAssetsHistory(ViewState("pProjNo"), txtProjectTitle.Text, DefaultTMID, "Notification sent to " & EmpName, "", "", "", "")
                                        End If
                                    Else
    ...
    Protected Sub gvApprovers_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvApprovers.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If imgBtn IsNot Nothing Then
                ...
                ' Get information about the product bound to the row
                If db.CommandName = "Delete" Then
                    Dim price As ExpProjAssets.ExpProj_Assets_ApprovalRow = CType(CType(e.Row.DataItem, System.Data.DataRowView).Row, ExpProjAssets.ExpProj_Assets_ApprovalRow)
...
#Region "Email Notifications"
    ...
    Public Function BuildApprovalList() As String
        Try
            ...
            Dim CurrentEmpEmail As String = Nothing
            CurrentEmpEmail = HttpContext.Current.Request.Cookies("UGNDB_User_Email").Value
            Dim UGNLocation As String = txtHDUGNLocation.Text
            ...
            If CurrentEmpEmail <> Nothing Then
                '' If ViewState("pProjNo") <> Nothing And ((txtRoutingStatus.Text = "N") Or (txtRoutingStatus.Text = "R")) Then
                If ViewState("pProjNo") <> Nothing Then
                    If (txtRoutingStatus.Text = "R") Or (txtRoutingStatus.Text = "N") Then
                        ''***************
                        ''* Delete 1st Level Approval for rebuild
                        ''***************
                        EXPModule.DeleteExpProjAssetsApproval(ViewState("pProjNo"), 0)

                        '***************
                        '* Build 1st level Approval
                        '***************
                        EXPModule.InsertExpProjAssetsApproval(ViewState("pProjNo"), IIf(UGNLocation = "", ddUGNLocation.SelectedValue, UGNLocation), 80, DefaultUser, DefaultDate)

                        '***************
                        '* Build 2nd Level Approval
                        '***************
                        EXPModule.InsertExpProjAssetsApproval(ViewState("pProjNo"), IIf(UGNLocation = "", ddUGNLocation.SelectedValue, UGNLocation), 81, DefaultUser, DefaultDate)

                        '***************
                        '* Build 3rd Level Approval
                        '***************
                        EXPModule.InsertExpProjAssetsApproval(ViewState("pProjNo"), IIf(UGNLocation = "", ddUGNLocation.SelectedValue, UGNLocation), 82, DefaultUser, DefaultDate)

                        '***************
                        '* Build 4th Level Approval
                        '***************
                        EXPModule.InsertExpProjAssetsApproval(ViewState("pProjNo"), IIf(UGNLocation = "", ddUGNLocation.SelectedValue, UGNLocation), 83, DefaultUser, DefaultDate)
    ...
    Protected Sub btnFwdApproval_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnFwdApproval.Click, btnCRProjNoReq.Click
        Try
            ''********
            ...
            If CurrentEmpEmail <> Nothing And ViewState("pProjNo") <> Nothing Then
                ...
                ''***************
                ''Verify that Cost Reduction Ref # is not required
                ''***************
                Dim a As Integer = 0
                Dim ds As DataSet = New DataSet
                ...
                If commonFunctions.CheckDataSet(ds) = True Then
                    For a = 0 To ds.Tables.Item(0).Rows.Count - 1
                        If ds.Tables(0).Rows(a).Item("CSCode") = "C" Then
                            If ddCRProjNo.SelectedValue = Nothing Then
                                SendCRNotif = True
                            Else
                                SendCRNotif = False
                ...
                If (txtRoutingStatus.Text <> "R") And ViewState("DefaultUserFacility") <> "UT" Then
                    ''***************
                    ''* Delete 1st Level Approval for rebuild
                    ''***************
                    EXPModule.DeleteExpProjAssetsApproval(ViewState("pProjNo"), 1)

                    '***************
                    '* Build Approval List
                    '***************
                    'EXPModule.InsertExpProjAssetsApproval(ViewState("pProjNo"), UGNLocation, 80, DefaultUser, DefaultDate)
                    BuildApprovalList()
                Else
                    If ViewState("DefaultUserFacility") <> "UT" Then
                        ...
                        txtHDTotalInvestment.Text <> lblTotalInvestment.Text Then
                            BuildApprovalList()
                            EXPModule.InsertExpProjAssetsHistory(ViewState("pProjNo"), txtProjectTitle.Text, DefaultTMID, "Total Investment amount changed from $" & txtHDTotalInvestment.Text & " to $" & lblTotalInvestment.Text, "Total Investment", txtHDTotalInvestment.Text, lblTotalInvestment.Text, "")
                ...
                '**************
                If (txtRoutingStatus.Text = "N" Or txtRoutingStatus.Text = "R") And _
                ViewState("DefaultUserFacility") = "UT" Then
                    Dim Level1Found As Boolean = False
                    ds = EXPModule.GetAssetsExpProjApproval(ViewState("pProjNo"), 0, 0, False, False)
                    If commonFunctions.CheckDataSet(ds) = True Then
                        For a = 0 To ds.Tables.Item(0).Rows.Count - 1
                ...
                If ReqAssetFound = False Then
                    ''**********************
                    ''* Save data prior to submission before approvals
                    ''**********************
                    UpdateRecord(IIf(SendCRNotif = True, "Hold", "In Process"), IIf(SendCRNotif = True, "H", "T"), True)
                    ...
                    ''*********************************
                    If SendCRNotif = False Then
                        ''*******************************
                        ''Locate 1st level approver
                        ''*******************************
                        If (txtRoutingStatus.Text <> "R") Then
                            ds1st = EXPModule.GetAssetsExpProjApproval(ViewState("pProjNo"), 1, 0, False, False)
                        Else 'IF Rejected - only notify the TM who Rejected the record
                            If txtHDTotalInvestment.Text = lblTotalInvestment.Text Then
                                ds1st = EXPModule.GetAssetsExpProjApproval(ViewState("pProjNo"), 0, 0, False, True)
                            Else
                                ds1st = EXPModule.GetAssetsExpProjApproval(ViewState("pProjNo"), 1, 0, False, False)
                            End If
                        End If
                        ...
                        If commonFunctions.CheckDataSet(ds1st) = True Then
                            For i = 0 To ds1st.Tables.Item(0).Rows.Count - 1
                                ...
                                (ddProjectLeader.SelectedValue <> ds1st.Tables(0).Rows(i).Item("TeamMemberID")) Then
                                    ...
                                    ''************************************************************
                                    If (txtRoutingStatus.Text <> "R") Then
                                        EXPModule.UpdateExpProjAssetsApproval(ViewState("pProjNo"), ds1st.Tables(0).Rows(i).Item("TeamMemberID"), False, "Pending", "", 1, 0, DefaultUser, DefaultDate)
                                    Else 'IF Rejected - only notify the TM who Rejected the record
                                        EXPModule.UpdateExpProjAssetsApproval(ViewState("pProjNo"), ds1st.Tables(0).Rows(i).Item("TeamMemberID"), False, "Pending", "", ds1st.Tables(0).Rows(i).Item("SeqNo"), 0, DefaultUser, DefaultDate)
                                ...
                                Else
                                    ...
                                    ''************************************************************
                                    If (txtRoutingStatus.Text <> "R") Then
                                        EXPModule.UpdateExpProjAssetsApproval(ViewState("pProjNo"), ds1st.Tables(0).Rows(i).Item("TeamMemberID"), True, "Approved", "", 1, 1, DefaultUser, DefaultDate)
                                    Else 'IF Rejected - only notify the TM who Rejected the record
                                        EXPModule.UpdateExpProjAssetsApproval(ViewState("pProjNo"), ds1st.Tables(0).Rows(i).Item("TeamMemberID"), False, "Approved", "", ds1st.Tables(0).Rows(i).Item("SeqNo"), 1, DefaultUser, DefaultDate)
                                        SeqNo = ds1st.Tables(0).Rows(i).Item("SeqNo")
                                        OrigTMID = ds1st.Tables(0).Rows(i).Item("OrigTeamMemberID")
                                    End If
                        ...
                        If SponsSameAs1stLvlAprvr = True And EmailTO = Nothing Then
                            ds2nd = EXPModule.GetAssetsExpProjApproval(ViewState("pProjNo"), 2, 0, False, False)
                            ''Check that the recipient(s) is a valid Team Member
                            If commonFunctions.CheckDataSet(ds2nd) = True Then
                                For i = 0 To ds2nd.Tables.Item(0).Rows.Count - 1
                                    If (ds2nd.Tables(0).Rows(i).Item("WorkStatus") = True) Then
                                        ...
                                        ''************************************************************
                                        EXPModule.UpdateExpProjAssetsApproval(ViewState("pProjNo"), ds2nd.Tables(0).Rows(i).Item("TeamMemberID"), False, "Pending", "", 2, 0, DefaultUser, DefaultDate)
                    ...
                    If EmailTO <> Nothing Then
                        ...
                        If (txtRoutingStatus.Text = "R") And txtHDTotalInvestment.Text = lblTotalInvestment.Text Then
                            ''********************************
                        ...
                        If SendCRNotif = True Then 'Notification going to CR Project Leaders based on UGNFacility selection
                            MyMessage.Body &= "<p><font size='2' face='Tahoma'>" & ViewState("pProjNo") & " '" & txtProjectTitle.Text & "' requires a Cost Reduction Project entry. <a href='" & ViewState("strProdOrTestEnvironment") & "/CR/CostReduction.aspx?pProjNo=0&pCPNo=" & ViewState("pProjNo") & "'>Click here</a> to create a new record. Below is a summary of the Asset for your review. For additional information about the Asset <a href='" & ViewState("strProdOrTestEnvironment") & "/EXP/AssetsExpProj.aspx?pProjNo=" & ViewState("pProjNo") & "'>click here</a>.</font></p>"
                        Else
                            MyMessage.Body &= "<font size='2' face='Tahoma'>" & EmpName & "</font>"
                            MyMessage.Body &= "<p><font size='2' face='Tahoma'>" & ViewState("pProjNo") & " '" & txtProjectTitle.Text & "' is available for your Review/Approval. <a href='" & ViewState("strProdOrTestEnvironment") & "/EXP/crExpProjAssetsApproval.aspx?pProjNo=" & ViewState("pProjNo") & "&pAprv=1" & "'>Click here</a> to access the record.</font></p>"
                        End If
                        ...
                        ''*****************
                        If SendCRNotif = True Then 'Notification going to CR Project Leaders based on UGNFacility selection
                            EXPModule.InsertExpProjAssetsHistory(ViewState("pProjNo"), txtProjectTitle.Text, DefaultTMID, "Cost Reduction Project request sent to " & EmpName & "..", "", "", "", "")
                        Else
                            If txtReSubmit.Text = Nothing Then
                                EXPModule.InsertExpProjAssetsHistory(ViewState("pProjNo"), txtProjectTitle.Text, DefaultTMID, "Record completed and forwarded to " & EmpName & " for approval.", "", "", "", "")
                            Else
                                EXPModule.InsertExpProjAssetsHistory(ViewState("pProjNo"), txtProjectTitle.Text, DefaultTMID, "Record completed and forwarded to " & EmpName & " for approval.- Reason: " & txtReSubmit.Text, "", "", "", "")
                            End If
                        ...
                        Try
                            commonFunctions.Email.Send("", EmailFrom, MyMessage.Subject, MyMessage.Body, EmailTO, EmailCC, "", "Spending Request (A)", ViewState("pProjNo"))
                            If SendCRNotif = True Then
                                lblErrors.Text = "Cost Reduction Reference # required for Approval. Request Submitted Successfully. "
                                mvTabs.ActiveViewIndex = Int32.Parse(1)
                                mvTabs.GetActiveView()
                                mnuTabs.Items(1).Selected = True
                                ddCRProjNo.Focus()
        ...
        Try
            ...
            If IncludeOrigAprvlTM = True Then
                ...
                If commonFunctions.CheckDataSet(dsCC) = True Then
                    For i = 0 To dsCC.Tables.Item(0).Rows.Count - 1
                        If (dsCC.Tables(0).Rows(i).Item("WorkStatus") = True) And _
                        (ddProjectLeader.SelectedValue <> dsCC.Tables(0).Rows(i).Item("TeamMemberID")) Then ''change to DefaultTMID   
    ...
    Public Function EmailBody(ByVal MyMessage As MailMessage) As String
        ...
        MyMessage.Body &= "<td>" & lblSubtotalAssets.Text & "</td>"
        MyMessage.Body &= "</tr>"
        MyMessage.Body &= "<tr>"
        ...
        MyMessage.Body &= "<td>" & txtSalvageValue.Text & "</td>"
        MyMessage.Body &= "</tr>"
        MyMessage.Body &= "<tr>"
        MyMessage.Body &= "<td class='p_text' align='right'>Net Book Value ($):&nbsp;&nbsp; </td>"
        MyMessage.Body &= "<td>" & txtNetBookValue.Text & "</td>"
        MyMessage.Body &= "</tr>"
        MyMessage.Body &= "<tr>"
        MyMessage.Body &= "<td class='p_text' align='right'>Net Tax Value ($):&nbsp;&nbsp; </td>"
        MyMessage.Body &= "<td>" & txtNetTaxValue.Text & "</td>"
        MyMessage.Body &= "</tr>"
        ...
        MyMessage.Body &= "<td>" & txtRtnAvgAssets.Text & "</td>"
        MyMessage.Body &= "</tr>"
        MyMessage.Body &= "<tr>"
        ...
        MyMessage.Body &= "<td>" & txtPayback.Text & "</td>"
        MyMessage.Body &= "</tr>"
        ...
        Try
            ...
            If CurrentEmpEmail <> Nothing And ViewState("pProjNo") <> Nothing Then
                ...
                If GroupNotif = True Then
                    ...
                    ''*******************************
                    ds1st = EXPModule.GetAssetsExpProjApproval(ViewState("pProjNo"), 0, 0, False, False)
                    ''Check that the recipient(s) is a valid Team Member
                    If commonFunctions.CheckDataSet(ds1st) = True Then
                        For i = 0 To ds1st.Tables.Item(0).Rows.Count - 1
                            If (ds1st.Tables(0).Rows(i).Item("Email") <> CurrentEmpEmail) And _
                            (ds1st.Tables(0).Rows(i).Item("WorkStatus") = True) And _
                            (ddProjectLeader.SelectedValue <> ds1st.Tables(0).Rows(i).Item("TeamMemberID")) Then ''change to DefaultTMID   
                    ...
                    ''Notify Project Lead
                    ''********************************************************
                    ds1st = EXPModule.GetExpProjAssetsLead(ViewState("pProjNo"))
                    ''Check that the recipient(s) is a valid Team Member
                    If commonFunctions.CheckDataSet(ds1st) = True Then
                        For i = 0 To ds1st.Tables.Item(0).Rows.Count - 1
            ...
            If EmailTO <> Nothing Then
                ...
                MyMessage.Subject &= "Property Plant Equipment (Asset): " & ViewState("pProjNo") & " - " & txtProjectTitle.Text & " - " & EventDesc
                ...
                Else
                    MyMessage.Body &= "<tr bgcolor='#EBEBEB'><td colspan='2'><strong>This Asset was '" & EventDesc.ToUpper & "' by " & DefaultUserName & ".</strong></td>"
                End If

                MyMessage.Body &= "</tr>"
                MyMessage.Body &= "<tr>"
                MyMessage.Body &= "<td class='p_text' align='right' style='width: 150px;'>Project No:&nbsp;&nbsp; </td>"
                MyMessage.Body &= "<td> <a href='" & ViewState("strProdOrTestEnvironment") & "/EXP/AssetsExpProj.aspx?pProjNo=" & ViewState("pProjNo") & "'>" & ViewState("pProjNo") & "</a></td>"
                MyMessage.Body &= "</tr>"
                MyMessage.Body &= "<tr>"
                MyMessage.Body &= "<td class='p_text' align='right'>Project Title:&nbsp;&nbsp; </td>"
                MyMessage.Body &= "<td>" & txtProjectTitle.Text & "</td>"
