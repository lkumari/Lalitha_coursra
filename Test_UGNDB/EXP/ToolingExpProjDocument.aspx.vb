' ************************************************************************************************
' Name:	ToolingExpProjDocument.aspx.vb
' Purpose:	This program is used to help display the file uploads in PDF format.
'
' Date		    Author	    
' 02/23/2010    LRey			Created .Net application
' ************************************************************************************************
Partial Class Exp_ToolingExpProjDocument
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If ViewState("pDocID") > 0 And ViewState("pProjNo") <> "" Then
            ...
            Dim ds As DataSet = EXPModule.GetToolingExpDocument(ViewState("pProjNo"), ViewState("pDocID"))
