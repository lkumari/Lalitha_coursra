<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DrawingPartNoLookUp.aspx.vb"
    Inherits="PE_PE_Drawings_DrawingPartNoLookUp" %>
            ...
            <tr>
                <td style="white-space: nowrap;" align="left" colspan="5">
                    <asp:GridView ID="gvPartList" runat="server" AutoGenerateColumns="False" DataKeyNames="PartNo"
                        DataSourceID="odsPartList" AllowPaging="True" Width="98%" PageSize="15">
                    ...
                    <asp:ObjectDataSource ID="odsPartList" runat="server" SelectMethod="GetParts"
                        TypeName="Parts" OldValuesParameterFormatString="original_{0}">
                        <SelectParameters>
