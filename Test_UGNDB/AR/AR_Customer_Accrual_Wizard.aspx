<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    MaintainScrollPositionOnPostback="true" CodeFile="AR_Customer_Accrual_Wizard.aspx.vb"
    Inherits="AR_Customer_Accrual_Wizard" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="maincontent" runat="Server">
    <asp:Panel ID="localPanel" runat="server">
        ...
        <asp:Button ID="btnSelectParts" runat="server" Text="Select All Parts Currently Showing" Visible="false" />
        <asp:Button ID="btnUnselectParts" runat="server" Text="Unselect All Parts Currently Showing" Visible="false" />
