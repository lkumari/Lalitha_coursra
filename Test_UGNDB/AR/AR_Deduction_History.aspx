<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="AR_Deduction_History.aspx.vb" Inherits="AR_ARDeductionHistory"
    Title="Untitled Page" %>
        ...
        <table>
            <tr>
                ...
                <td class="p_textbold" style="color: #990000">
                    <asp:Label ID="lblARDID" runat="server" Text=""></asp:Label>
                </td>
                <td>
                    &nbsp;</td>
                <td class="p_text">
                    Reason for Deduction:</td>
                <td class="p_textbold" style="color: #990000">
                                ...
                                <tr>
                                    ...
                                    <td valign="middle">
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:HyperLink ID="lnkCommBoad" runat="server" NavigateUrl='<%# GoToCommBoard(DataBinder.Eval(Container, "DataItem.ARDID"), DataBinder.Eval(Container, "DataItem.ActionDesc")) %>'
                                                        ImageUrl="~/images/messanger30.jpg" Visible='<%#  ShowHideLink(DataBinder.Eval(Container, "DataItem.ActionDesc")) %>' />
                                                </td>
                                                <td>
                                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# GoToCommBoard(DataBinder.Eval(Container, "DataItem.ARDID"), DataBinder.Eval(Container, "DataItem.ActionDesc")) %>'
