' ************************************************************************************************
' Name:	AR_Event_History.aspx.vb
' Purpose:	This program is used to bind data and execute bind data to repeater row commands.
'
' Date		    Author	    
' 04/01/2010    Roderick Carlson			Created .Net application
' ************************************************************************************************
Partial Class AR_Event_History
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        Try
            ...
            m.PageTitle = "UGN, Inc."
            m.ContentLabel = "AR Event History"

            ''*****
            ''Expand menu item
            ''*****
            Dim testMasterPanel As CollapsiblePanelExtender
            testMasterPanel = CType(Master.FindControl("ARExtender"), CollapsiblePanelExtender)
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If HttpContext.Current.Session("sessionARHisotryCurrentPage") IsNot Nothing Then
                CurrentPage = HttpContext.Current.Session("sessionARHisotryCurrentPage")
            End If
            ...
            If Not mpTextBox Is Nothing Then
                mpTextBox.Text = "<a href='../Home.aspx'><b>Home</b></a> > <b>Accounts Receivable Tracking </b> > <a href='AR_Event_List.aspx'>AR Event Search </a> > <a href='AR_Event_Detail.aspx?AREID=" & ViewState("AREID") & "'> Event Detail </a> > Event History "
    ...
    Private Sub BindData()
        ...
        Try
            ...
            ds = ARGroupModule.GetAREventHistory(ViewState("AREID"))

            If commonFunctions.CheckDataset(ds) = True Then

                rpARHistory.DataSource = ds
                rpARHistory.DataBind()
...
#Region "Paging Routine"
    ...
    Protected Sub cmdPrev_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdPrev.Click
        ...
        Try
            ...
            CurrentPage -= 1
            HttpContext.Current.Session("sessionARHistoryCurrentPage") = CurrentPage
...
#End Region 'EOF Paging Routine
    Public Function GoToCommBoard(ByVal AREID As String, ByVal ActionDesc As String) As String
        If ActionDesc = "Message Sent" Then
            Return "AR_Event_Detail.aspx?AREID=" & AREID ' & "&pRC=1"
        Else
            Return ""
        End If
