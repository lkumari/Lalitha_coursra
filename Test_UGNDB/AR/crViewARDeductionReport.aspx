<%@ Page Language="VB" AutoEventWireup="false" CodeFile="crViewARDeductionReport.aspx.vb"
    Inherits="AR_crViewARDeductionReport" Title="Untitled Page" %>
...
<body>
    <asp:Panel ID="localPanel" runat="server" Width="100%">
        ...
        <CrystalRpt:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="AR\Forms\crARDeductionReport.rpt">
            </Report>
