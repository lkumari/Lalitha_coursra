' ************************************************************************************************
' Name:	AR_Deduction_History.aspx.vb
...
' ************************************************************************************************
Partial Class AR_ARDeductionHistory
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If ctl IsNot Nothing Then
                ...
                lbl.Text = "<a href='../Home.aspx'><b>Home</b></a> > <b>Account Receivable</b> > <a href='AR_Deduction_List.aspx'><b>Operations Deduction Form Search</b></a> > History"
                lbl.Visible = True
            End If
    ...
    Private Sub BindData()
        ...
        Try
            ...
            ds = ARGroupModule.GetARDeductionHistory(ViewState("pARDID"))

            If ds IsNot Nothing Then
                If ds.Tables.Count > 0 Then
                    lblARDID.Text = ds.Tables(0).Rows(0).Item("ARDID").ToString()
                    lblReason.Text = ds.Tables(0).Rows(0).Item("ReasonDesc").ToString()
...
#End Region 'EOF Paging Routine
    ...
    Public Function GoToCommBoard(ByVal ARDID As String, ByVal ActionDesc As String) As String
        If ActionDesc = "Message Sent" Then
            Return "AR_Deduction.aspx?pARDID=" & ARDID & "&pRC=1"
        Else
            Return ""
        End If
