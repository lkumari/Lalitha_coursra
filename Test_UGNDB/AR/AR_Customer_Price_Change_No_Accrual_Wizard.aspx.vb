' ************************************************************************************************
'
' Name:		AR_Customer_Price_Change_No_Accrual_Wizard.aspx
' Purpose:	This Code Behind is for the AR Part Accrual Wizard
'
' Customer Price Change No Accrual 
'   i.	    Created by Sales 
'   ii.	    Require at least one Part and ONLY ONE UGN FACILITY, search by SoldTo first
'   iii.    Selection criteria based on Shipping History
'
' Date		Author	    
' 08/22/2012   Roderick Carlson


Partial Class AR_Customer_Price_Change_No_Accrual_Wizard
    ...
    Private Sub BindSoldTo(ByVal UGNFacility As String)
        ...
        Try
            ...
            Session("SOLDTOWhereClause") = Session("COMPNYWhereClause") & Session("CABBVWhereClause")
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        Try
            ...
            m.PageTitle = "UGN, Inc."
            m.ContentLabel = "AR Customer Price Change No Accrual Wizard"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                Session("SOLDTOWhereClause") &= " AND SOLDTO > 0 AND SHPDTE >= '20000101' "
            ...
            If Not mpTextBox Is Nothing Then
                mpTextBox.Text = "<a href='../Home.aspx'><b>Home</b></a> > <b>Accounts Receivable Tracking </b> > <a href='AR_Event_List.aspx'>AR Event Search </a> > <a href='AR_Event_Detail.aspx?AREID=" & ViewState("AREID") & "'> Event Detail </a> > Customer Price Change No Accrual Wizard "
    ...
    Protected Sub btnClearSoldTO_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnClearSoldTo.Click
        ...
        Try
            ...
            If ddUGNFacility.SelectedIndex >= 0 Then
                ...
                Session("SOLDTOWhereClause") = Session("COMPNYWhereClause") & Session("CABBVWhereClause") & " AND SOLDTO > 0 AND SHPDTE >= '20000101' "
    ...
    Protected Sub btnFilterCABBV_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnFilterCABBV.Click
        ...
        Try
            Dim SelectedPRCCDEList As New Collections.ArrayList()
            Dim iPRCCDETotalCount As Integer = 0
            Dim strPRCCDEList As String = ""
            Dim strTempPRCCDEWhereClause As String = ""
            ...
            If Session("CHECKED_PRCCDE_ITEMS") IsNot Nothing Then
                'get all selected PriceCodes
                SelectedPRCCDEList = DirectCast(Session("CHECKED_PRCCDE_ITEMS"), Collections.ArrayList)

                If Session("CHECKED_PRCCDE_ITEMS") IsNot Nothing And SelectedPRCCDEList IsNot Nothing Then
                    iPRCCDETotalCount = SelectedPRCCDEList.Count
                End If

                strTempPRCCDEWhereClause = " AND PRCCDE IN  ("

                If iPRCCDETotalCount > 0 Then
                    For iPRCCDERowCounter = 0 To iPRCCDETotalCount - 1
                        If strPRCCDEList <> "" Then
                            strPRCCDEList &= ","
                        End If

                        strPRCCDEList &= "'" & SelectedPRCCDEList(iPRCCDERowCounter).ToString.Trim & "'"
                    Next
                End If

                If strPRCCDEList <> "" Then
                    strTempPRCCDEWhereClause &= strPRCCDEList & ")"
                End If
                ...
                If Session("PRCCDEWhereClause") IsNot Nothing Then
                    If Session("PRCCDEWhereClause").ToString <> "" Then
                        ...
                        'Session("PRCCDEWhereClause") = Session("SOLDTOWhereClause") & strTempPRCCDEWhereClause
                        Session("CABBVWhereClause") = Session("SOLDTOWhereClause") & Session("COMPNYWhereClause") & strTempPRCCDEWhereClause & " AND SOLDTO > 0 AND SHPDTE >= '20000101' "
                        Session("PARTNOWhereClause") = Session("CABBVWhereClause")
                    End If
                End If
            ...
            Else 'no PRCCDEs selected
                '   Session("PARTNOWhereClause") = Session("SOLDTOWhereClause") & Session("PRCCDEWhereClause")
                lblMessage.Text = "Please check at least one Price Code item in the list"
            End If
                            ...
                            For iPriceCodeRowCounter = 0 To SelectedPriceCodeList.Count - 1
                                ...
                                If strPriceCode <> "" Then
                                        ...
                                        For iCABBVRowCounter = 0 To SelectedCABBVList.Count - 1
                                            ...
                                            If iPARTNOTotalCount > 0 Then
                                                ...
                                                For iPARTNORowCounter = 0 To SelectedPARTNOList.Count - 1
                                                    ...
                                                    ds = ARGroupModule.GetARShippingHistory(strUGNFacility, strCABBV, strSOLDTO, strPARTNO, strPriceCode, "", "", "", "", "", "", "")
                                                ...
                                                '    ds = ARGroupModule.GetARShippingHistory(strUGNFacility, strCABBV, strSOLDTO, "", strPriceCode, "", "", "", "", "")
                                    ...
                                    Else
                                        ...
                                        ds = ARGroupModule.GetARShippingHistory(strUGNFacility, "", strSOLDTO, "", strPriceCode, "", "", "", "", "", "", "")
                                        ...
                                        If commonFunctions.CheckDataSet(ds) = True Then
                                            ...
                                            If iPARTNOTotalCount > 0 Then
                                                ...
                                                For iPARTNORowCounter = 0 To SelectedPARTNOList.Count - 1
                                                    ...
                                                    ds = ARGroupModule.GetARShippingHistory(strUGNFacility, "", strSOLDTO, strPARTNO, strPriceCode, "", "", "", "", "", "", "")
                        ...
                        Else 'no price code selected
                            ...
                            If iCABBVTotalCount > 0 Then
                                ...
                                For iCABBVRowCounter = 0 To SelectedCABBVList.Count - 1
                                    ...
                                    ds = ARGroupModule.GetARShippingHistory(strUGNFacility, strCABBV, strSOLDTO, "", "", "", "", "", "", "", "", "")
                                    ...
                                    If commonFunctions.CheckDataSet(ds) = True Then
                                        ...
                                        If iPARTNOTotalCount > 0 Then
                                            ...
                                            For iPARTNORowCounter = 0 To SelectedPARTNOList.Count - 1
                                                ...
                                                ds = ARGroupModule.GetARShippingHistory(strUGNFacility, strPARTNO, strSOLDTO, "", "", "", "", "", "", "", "", "")
                            ...
                            Else 'if no cabbv selected, nor was a price code selected, only a SoldTo and maybe part was selected
                                ds = ARGroupModule.GetARShippingHistory(strUGNFacility, "", strSOLDTO, "", "", "", "", "", "", "", "", "")
                                ...
                                If commonFunctions.CheckDataSet(ds) = True Then
                                    ...
                                    If iPARTNOTotalCount > 0 Then
                                        ...
                                        For iPARTNORowCounter = 0 To SelectedPARTNOList.Count - 1
                                            ...
                                            ds = ARGroupModule.GetARShippingHistory(strUGNFacility, "", strSOLDTO, strPARTNO, "", "", "", "", "", "", "", "")
    ...
    Protected Sub btnFilterSoldTo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnFilterSoldTo.Click
        ...
        Try
            ...
            If ddUGNFacility.SelectedIndex >= 0 Then
                ...
                Session("SOLDTOWhereClause") = Session("COMPNYWhereClause") & strTempSOLDTOWhereClause & " AND SOLDTO > 0 AND SHPDTE >= '20000101' AND PRCCDE IN ('A','S') "
            ...
            If Session("CHECKED_SOLDTO_ITEMS") IsNot Nothing Then
                ...
                If Session("SOLDTOWhereClause") IsNot Nothing Then
                    If Session("SOLDTOWhereClause").ToString <> "" Then
                        ...
                        Session("PRCCDEWhereClause") = Session("PRCCDEWhereClause") & Session("COMPNYWhereClause") & strTempSOLDTOWhereClause & " AND SOLDTO > 0 AND SHPDTE >= '20000101' " '& Session("CABBVWhereClause")
                    End If
                End If
            ...
            If Session("CHECKED_CABBV_ITEMS") IsNot Nothing Then
                ...
                If Session("CABBVWhereClause") IsNot Nothing Then
                    If Session("CABBVWhereClause").ToString <> "" Then
                        ...
                        Session("PARTNOWhereClause") = Session("SOLDTOWhereClause") & strTempCABBVWhereClause & strTempPRCCDEWhereClause
                    End If
                End If

            Else 'no cabbvs selected
                'Session("PARTNOWhereClause") = Session("SOLDTOWhereClause") & Session("PRCCDEWhereClause")
                Session("PARTNOWhereClause") = Session("SOLDTOWhereClause") & strTempPRCCDEWhereClause
            End If


            Session("PARTNOWhereClause") = Session("PARTNOWhereClause") & " AND SOLDTO > 0 AND SHPDTE >= '20000101' "
