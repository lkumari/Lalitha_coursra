<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    MaintainScrollPositionOnPostback="true" CodeFile="AR_Accounting_Accrual_Wizard.aspx.vb"
    Inherits="AR_Accounting_Accrual_Wizard" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="maincontent" runat="Server">
    <asp:Panel ID="localPanel" runat="server">
        ...
        <asp:TextBox runat="server" ID="txtSoldTo" MaxLength="15" Visible="false"></asp:TextBox>
        <br />
        ...
        <asp:TextBox runat="server" ID="txtPriceCode" MaxLength="1" Visible="false"></asp:TextBox>
        <br />
        ...
        <asp:TextBox runat="server" ID="txtCABBV" MaxLength="1" Visible="false"></asp:TextBox>
        <br />
        <br />
