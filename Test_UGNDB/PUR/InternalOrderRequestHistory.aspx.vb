' ************************************************************************************************
' Name:	InternalOrderRequestHistory.aspx.vb
' Purpose:	This program is used to bind data and execute bind data to repeater row commands.
'
' Date		    Author	    
' 10/04/2010    LRey			Created .Net application
' ************************************************************************************************
Partial Class PUR_InternalOrderRequestHistory
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            m.PageTitle = "UGN, Inc."
            m.ContentLabel = "Internal Order Request History"
            ...
            If ctl IsNot Nothing Then
                ...
                lbl.Text = "<a href='../Home.aspx'><b>Home</b></a> > <b>Purchasing</b> > <a href='InternalOrderRequestList.aspx'><b>Internal Order Request Search</b></a> > History"
                lbl.Visible = True
            End If
    ...
    Private Sub BindData()
        ...
        Try
            ...
            ds = PURModule.GetInternalOrderRequestHistory(ViewState("pIORNo"))

            If ds IsNot Nothing Then
                If ds.Tables.Count > 0 Then
                    lblIORNo.Text = ds.Tables(0).Rows(0).Item("IORNo").ToString()
                    lblIORDescription.Text = ds.Tables(0).Rows(0).Item("IORDescription").ToString()

                    rpInternalOrderRequest.DataSource = ds
                    rpInternalOrderRequest.DataBind()
                    ...
                    rpInternalOrderRequest.DataSource = objPds
                    rpInternalOrderRequest.DataBind()
...
#End Region 'EOF Paging Routine
    ...
    Public Function GoToCommBoard(ByVal IORNo As String, ByVal ActionDesc As String) As String
        If ActionDesc = "Message Sent" Then
            Return "InternalOrderRequest.aspx?pIORNo=" & IORNo & "&pRC=1"
        Else
            Return ""
        End If
