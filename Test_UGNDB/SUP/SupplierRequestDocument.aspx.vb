' ************************************************************************************************
' Name:	SupplierRequestDocument.aspx.vb
' Purpose:	This program is used to help display the file uploads in PDF format.
'
' Date		    Author	    
' 09/23/2010    LRey			Created .Net application
' ************************************************************************************************
Partial Class SUP_SupplierRequestDocument
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If ViewState("pDocID") > 0 And ViewState("pSUPNo") <> "" Then

                Dim ds As DataSet = SUPModule.GetSupplierRequestDocuments(ViewState("pSUPNo"), ViewState("pDocID"))
