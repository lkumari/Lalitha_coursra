<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="SupplierRequestHistory.aspx.vb" Inherits="SUP_SupplierRequestHistory"
    Title="Untitled Page" %>
    ...
    <asp:Panel ID="localPanel" runat="server" Width="1000px">
        ...
        <table>
            <tr>
                ...
                <td class="p_textbold" style="color: #990000">
                    <asp:Label ID="lblSUPNo" runat="server" Text=""></asp:Label>
                </td>
                <td>
                    &nbsp;</td>
                <td class="p_text">
        ...
        <table id="TABLE1" width="70%">
            <tbody>
                ...
                <tr>
                    <td colspan="4">
                        &nbsp;<asp:Repeater ID="rpSupplierRequest" runat="server">
                            <SeparatorTemplate>
                                <tr>
                                    <td colspan="4">
                                ...
                                <tr>
                                    ...
                                    <td valign="middle">
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:HyperLink ID="lnkCommBoad" runat="server" NavigateUrl='<%# GoToCommBoard(DataBinder.Eval(Container, "DataItem.SUPNo"), DataBinder.Eval(Container, "DataItem.ActionDesc")) %>'
                                                        ImageUrl="~/images/messanger30.jpg" Visible='<%#  ShowHideLink(DataBinder.Eval(Container, "DataItem.ActionDesc")) %>' />
                                                </td>
                                                <td>
                                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# GoToCommBoard(DataBinder.Eval(Container, "DataItem.SUPNo"), DataBinder.Eval(Container, "DataItem.ActionDesc")) %>'
