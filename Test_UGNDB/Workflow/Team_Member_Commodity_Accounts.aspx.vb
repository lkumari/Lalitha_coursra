''******************************************************************************************************
''* Team_Member_Commodity_Accounts.aspx.vb
''* The purpose of this page is to allow users to maintain and insert new Team_Member_Commodity_Accounts data.
''*
''* Author  : LRey 08/18/2008
''******************************************************************************************************
Imports System.Data
Imports System.Data.SqlClient
Partial Class Workflow_Team_Member_Commodity_Accounts
    Inherits System.Web.UI.Page
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Dim m As ASP.masterpage_master = Master
            m.PageTitle = "UGN, Inc."
            m.ContentLabel = "Team Member Commodity Accounts"
            ''***********************************************
            ...
            If Not mpTextBox Is Nothing Then
                mpTextBox.Text = "<a href='../Home.aspx'><b>Home</b></a> > <b>Work Flow</b> > Team Member Commodity Accounts"
            ...
            If Not Page.IsPostBack Then
                ...
                ''******
                If Not Request.Cookies("WFCA_TeamMember") Is Nothing Then
                    ddTeamMember.SelectedValue = Server.HtmlEncode(Request.Cookies("WFCA_TeamMember").Value)
                    ViewState("sTeamMember") = Server.HtmlEncode(Request.Cookies("WFCA_TeamMember").Value)
                End If
...
#Region "Form Level Security using Roles &/or Subscriptions"
    Protected Sub CheckRights()
        ...
        Try
            ...
            Dim iFormID As Integer = 39 'Team Member Accounts form id
...
#End Region
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        ''******
        Response.Cookies("WFCA_TeamMember").Value = ddTeamMember.SelectedValue

        ''******
        '' Redirect to the Team Member Backups List page
        ''******
        Response.Redirect("Team_Member_Commodity_Accounts.aspx?sTeamMember=" & ddTeamMember.SelectedValue, True)
    ...
    Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
        ...
        ''******
        WorkFlowModule.DeleteWFCookies_TeamMemberCommodityAssignments()

        ''******
        '' Redirect to the Team Member Backups List page
        ''******
        Response.Redirect("Team_Member_Commodity_Accounts.aspx", True)
    End Sub
    ...
    Protected Sub gvWorkFlow_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvWorkFlow.RowCommand
        ...
        Dim CommodityID As DropDownList
        ...
        If e.CommandName = "Insert" Then
            ...
            CommodityID = CType(gvWorkFlow.FooterRow.FindControl("ddCommodity"), DropDownList)
            odsWorkFlow.InsertParameters("CommodityID").DefaultValue = CommodityID.SelectedValue
        ...
        If e.CommandName = "Undo" Then
            ...
            CommodityID = CType(gvWorkFlow.FooterRow.FindControl("ddCommodity"), DropDownList)
            CommodityID.ClearSelection()
            CommodityID.Items.Add("")
            CommodityID.SelectedValue = ""
        End If
    End Sub
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If imgBtn IsNot Nothing Then
                ...
                If db.CommandName = "Delete" Then
                    Dim TeamMember As WorkFlow.WorkFlow_Commodity_AssignmentsRow = CType(CType(e.Row.DataItem, System.Data.DataRowView).Row, WorkFlow.WorkFlow_Commodity_AssignmentsRow)

                    db.OnClientClick = String.Format("return confirm('Are you certain you want to delete Team Member (" & DataBinder.Eval(e.Row.DataItem, "TeamMemberName") & ")  Commodity (" & DataBinder.Eval(e.Row.DataItem, "CommodityName") & ")?');")
                End If
            End If
        End If
    End Sub
...
#Region "Insert Empty GridView Work-Around"
    ...
    Protected Sub odsWorkFlow_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles odsWorkFlow.Selected
        ...
        Dim dt As WorkFlow.WorkFlow_Commodity_AssignmentsDataTable = CType(e.ReturnValue, WorkFlow.WorkFlow_Commodity_AssignmentsDataTable)
