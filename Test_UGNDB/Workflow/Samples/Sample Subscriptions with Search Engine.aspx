<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="Sample Subscriptions with Search Engine.aspx.vb" Inherits="Workflow_Sample_Subscriptions_with_ObjectDataSource"
    Title="Untitled Page" %>
    ...
    <table>
        <tr>
            ...
            <td style="width: 108px; height: 15px;">
                <asp:TextBox ID="txtSuscriptionDescr" runat="server"></asp:TextBox>
            </td>
            ...
            <asp:TemplateField HeaderText="Subscription" SortExpression="Subscription">
                <EditItemTemplate>
                    ...
                    <asp:RequiredFieldValidator ID="rfvSubscription" runat="server" ControlToValidate="Subscription"
                        Display="Dynamic" ErrorMessage="You must enter a value for Subscription." Font-Bold="True"
...
Subscription?');" />
    ...
    <asp:ObjectDataSource ID="odsSubscriptions" runat="server" DeleteMethod="DeleteSubscription"
        ...
        UpdateMethod="UpdateSubscription"  >
        <DeleteParameters>
