...
Partial Class Workflow_Sample_Subscriptions_with_ObjectDataSource
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        m.ContentLabel = "Sample Subscriptions with Search Engine"
        ''***********************************************
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        Response.Redirect("Sample Subscriptions with Search Engine.aspx?Subscription=" & txtSuscriptionDescr.Text)

    End Sub
    Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
        Response.Redirect("Sample Subscriptions with Search Engine.aspx")
