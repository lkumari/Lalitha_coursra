<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RFD_Purchasing_Help.aspx.vb" Inherits="RFD_RFD_Purchasing_Help" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Request for Development (RFD) PURCHASING Help</title>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <p class="p_bigtextbold">
            Request For Development (RFD) Help FOR PURCHASING</p>
        <br />
        ...
        <span class="c_text">&nbsp;&nbsp;&nbsp;- When the designation type is a finished good,
            then it is optional to add a <b>P.O. Number</b>.<br />           
            &nbsp;&nbsp;&nbsp;- Nothing is required on this tab for child parts (that are NOT
            finished goods). </span>
        <br />
        <p class="c_textbold" style="color: Blue">
            Child PartNo</p>
        <span class="c_text">&nbsp;&nbsp;&nbsp;- When the designation type is a raw material, then a <b>P.O. Number</b> is required for
            each child part. Other types of parts are optional.<br />                
        ...
        <span class="c_text">&nbsp;&nbsp;&nbsp;Once the information has been saved, go to the
            ...
            &nbsp;&nbsp;&nbsp;<b>EACH PART THAT IS A RAW MATERIAL WILL REQUIRE A P.O. NUMBER BEFORE APPROVAL</b>.<br />
