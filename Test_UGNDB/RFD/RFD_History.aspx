...
AutoEventWireup="false" CodeFile="RFD_History.aspx.vb" 
Inherits="RFD_History" title="Untitled Page" %>
        ...
        <table>
            <tr>
                ...
                <td class="p_textbold" style="color: #990000">
                    <asp:Label ID="lblRFDNo" runat="server"></asp:Label>
                </td>               
            </tr>
        </table>
        <hr />
                                ...
                                <tr>
                                    ...
                                    <td valign="middle">
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:HyperLink ID="lnkDescriptionImage" runat="server" NavigateUrl='<%# GoToCommBoard(DataBinder.Eval(Container, "DataItem.RFDNo"), DataBinder.Eval(Container, "DataItem.ActionDesc")) %>'
                                                        ImageUrl="~/images/messanger30.jpg" Visible='<%#  ShowHideLink(DataBinder.Eval(Container, "DataItem.ActionDesc")) %>' />
                                                </td>
                                                <td>
                                                    <asp:HyperLink ID="lnkDescriptionText" runat="server" NavigateUrl='<%# GoToCommBoard(DataBinder.Eval(Container, "DataItem.RFDNo"), DataBinder.Eval(Container, "DataItem.ActionDesc")) %>'
