<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RFD_Tooling_Help.aspx.vb" Inherits="RFD_RFD_Tooling_Help" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Request for Development (RFD) CAPITAL AND TOOLING Help</title>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <p class="p_bigtextbold">
            Request For Development (RFD) Help FOR CAPITAL AND TOOLING</p>
        <br />
        <p class="c_textbold" style="color: Red">
            Required Fields</p>
        <br />
        <p class="c_textbold" style="color: Blue">
            Capital and Tooling Tab</p>
        <span class="c_text">
            &nbsp;&nbsp;&nbsp;A text box exists to input any important capital information.<br />
            &nbsp;&nbsp;&nbsp;A text box exists to input any important tooling information.
        </span>                   
        <br />
        <p class="c_textbold" style="color: Blue">
