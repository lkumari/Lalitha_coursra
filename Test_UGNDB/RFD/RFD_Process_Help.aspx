<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RFD_Process_Help.aspx.vb" Inherits="RFD_RFD_Process_Help" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Request for Development (RFD) PROCESS Help</title>
</head>
<body>
       <form id="form1" runat="server">
        ...
        <p class="p_bigtextbold">
            Request For Development (RFD) Help FOR PROCESS</p>
        <br />
        ...
        <p class="c_textbold" style="color: Blue">
            Process Tab</p>
        <span class="c_text">
            &nbsp;&nbsp;&nbsp;A text box exists to input any important process information.
        </span>                   
        <br />
        <p class="c_textbold" style="color: Blue">
