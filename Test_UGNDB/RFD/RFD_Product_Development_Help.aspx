<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RFD_Product_Development_Help.aspx.vb"
    Inherits="RFD_RFD_Product_Development_Help" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Request for Development (RFD) PRODUCT DEVELOPMENT Help</title>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <p class="p_bigtextbold">
            Request For Development (RFD) Help FOR PRODUCT DEVELOPMENT</p>
        <br />
        ...
        <span class="c_text">&nbsp;&nbsp;&nbsp;- When the designation type is a finished good,
            then the <b>New DMS Drawing Number</b> is required.<br />
            &nbsp;&nbsp;&nbsp;- Engineers can either generate a new DMS Drawing based on what
            the initiators entered or assign the New Drawing number manually.<br />
        ...
        <span class="c_text">&nbsp;&nbsp;&nbsp;- When the designation type is a raw material,
            formula, or semi-finished good, then a <b>New Drawing Number</b> is required for
            each child part.<br />
            &nbsp;&nbsp;&nbsp;- Again, engineers can either generate a new DMS Drawing based
            on what the initiators entered or assign the New Drawing number manually.<br />
