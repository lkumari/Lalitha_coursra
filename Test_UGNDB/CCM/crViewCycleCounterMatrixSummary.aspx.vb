' ************************************************************************************************
' Name:	crViewCycleCounterMatrixSummary.aspx.vb
...
' 07/26/2012    Lrey            Added StoreMonthEndValue function when option is checked.
' ************************************************************************************************
        ...
        Try
            ...
            If Session("TempCrystalRptFiles") Is Nothing Then
                ...
                If ViewState("pFormat") = "GV" Then
                    oRpt.Load(Server.MapPath(".\Forms\") & "crCCMSummary.rpt")
                Else
                    oRpt.Load(Server.MapPath(".\Forms\") & "crCCMChart.rpt")
                End If
                ...
                ' new report document object 
                If ViewState("pFormat") = "GV" Then
                    oRpt.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, True, "CCM_Summary_" & Tdate)
                Else
                    oRpt.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, True, "CCM_SummaryChart_" & Tdate)
                End If
