...
Partial Class RnD_TestReport
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If HttpContext.Current.Request.QueryString("pReqID") > 0 Then
                ViewState("pReqID") = HttpContext.Current.Request.QueryString("pReqID")
            Else
                ViewState("pReqID") = 0
            End If

            If ViewState("pRptID") > 0 And ViewState("pReqID") > 0 Then

                Dim ds As DataSet = RnDModule.GetTestReport(ViewState("pReqID"), ViewState("pRptID"))
