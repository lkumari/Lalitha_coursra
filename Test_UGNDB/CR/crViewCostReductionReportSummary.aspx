<%@ Page Language="VB" MasterPageFile="~/crViewMasterPage.master" AutoEventWireup="false"
    CodeFile="crViewCostReductionReportSummary.aspx.vb" Inherits="CR_crViewCostReductionReportSummary"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="maincontent" runat="Server">
    ...
    <CrystalRpt:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="CR\Forms\crCostReductionReportSummary.rpt">
        </Report>
