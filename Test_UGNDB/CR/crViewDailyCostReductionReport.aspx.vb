...
Partial Class CR_crViewDailyCostReductionReport
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not mpTextBox Is Nothing Then
            mpTextBox.Text = "<a href='../Home.aspx'><b>Home</b></a> > <b>Cost Reduction</b> > <a href='CostReductionReport.aspx'><b>Cost Reduction Report - Daily Summary</b></a>"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If Session("TempCrystalRptFiles") Is Nothing Then
            ...
            oRpt.Load(Server.MapPath(".\Forms\") & "crDailyCostReduction.rpt")
