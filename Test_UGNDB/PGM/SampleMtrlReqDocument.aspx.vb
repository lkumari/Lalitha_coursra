' ************************************************************************************************
' Name:	SampleMaterialRequestDocument.aspx.vb
' Purpose:	This program is used to help display the file uploads in PDF format.
'
' Date		    Author	    
' 02/20/2013   LRey			Created .Net application
' ************************************************************************************************
Partial Class PGM_SampleMaterialRequestDocument
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If ViewState("pDocID") > 0 And ViewState("pSMRNo") <> "" Then

            Dim ds As DataSet = PGMModule.GetSampleMtrlReqDocuments(ViewState("pSMRNo"), ViewState("pDocID"), "")
