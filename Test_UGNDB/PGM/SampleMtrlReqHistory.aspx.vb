' ************************************************************************************************
' Name:	SampleMtrlReqHistory.aspx.vb
' Purpose:	This program is used to bind data and execute bind data to repeater row commands.
'
' Date		    Author	    
' 02/27/2013    LRey			Created .Net application
' ************************************************************************************************
Partial Class PGM_SampleMtrlReqHistory
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            m.ContentLabel = "Sample Material Request History"
            ...
            If ctl IsNot Nothing Then
                ...
                lbl.Text = "<a href='../Home.aspx'><b>Home</b></a> > <b>Purchasing</b> > <a href='SampleMaterialRequestList.aspx'><b>Sample Material Request Search</b></a> > History"
                lbl.Visible = True
            End If
            ...
            Else
                ViewState("pSMRNo") = ""
            End If
            If HttpContext.Current.Session("sessionPGMCurrentPage") IsNot Nothing Then
                'CurrentPage = HttpContext.Current.Session("sessionPGMCurrentPage")
            End If
    ...
    Private Sub BindData()
        ...
        Try
            ...
            ds = PGMModule.GetSampleMtrlReqHistory(ViewState("pSMRNo"))

            If ds IsNot Nothing Then
                If ds.Tables.Count > 0 Then
                    lblSMRNo.Text = ds.Tables(0).Rows(0).Item("SMRNo").ToString()
                    lblSampleDesc.Text = ds.Tables(0).Rows(0).Item("SampleDesc").ToString()

                    rpSampleMtrlReq.DataSource = ds
                    rpSampleMtrlReq.DataBind()
                    ...
                    rpSampleMtrlReq.DataSource = objPds
                    rpSampleMtrlReq.DataBind()
...
#Region "Paging Routine"
    ...
    Protected Sub cmdPrev_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdPrev.Click
        ...
        Try
            ...
            CurrentPage -= 1
            HttpContext.Current.Session("sessionPGMCurrentPage") = CurrentPage
...
#End Region 'EOF Paging Routine
    ...
    Public Function GoToCommBoard(ByVal SMRNo As String, ByVal ActionDesc As String) As String
        If ActionDesc = "Message Sent" Then
            Return "SampleMaterialRequest.aspx?pSMRNo=" & SMRNo & "&pRC=1"
        Else
            Return ""
        End If
