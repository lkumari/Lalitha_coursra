...
Partial Class MFGCapacityProcessMaint
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            m.ContentLabel = "Capacity Process"
            ...
            If ctl IsNot Nothing Then
                ...
                lbl.Text = "<a href='../Home.aspx'><b>Home</b></a> > <b>Manufacturing</b> > Capacity Process"
                lbl.Visible = True
            End If
            ...
            If Not Page.IsPostBack Then
                ...
                If Not Request.Cookies("MFG_CPN") Is Nothing Then
                    txtProcess.Text = Server.HtmlEncode(Request.Cookies("MFG_CPN").Value)
                    ViewState("sMfgPN") = Server.HtmlEncode(Request.Cookies("MFG_CPN").Value)
                End If

            Else
                ViewState("sMfgCPN") = txtProcess.Text
            End If
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Try
            Response.Cookies("MFG_CPN").Value = txtProcess.Text

            Response.Redirect("MFGCapacityProcessMaint.aspx?sMfgCPN=" & Server.UrlEncode(txtProcess.Text.Trim), False)
        Catch ex As Exception
    ...
    Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
        ...
        Try
            MPRModule.DeleteMFGCapacityProcessCookies()

            Response.Redirect("MFGCapacityProcessMaint.aspx", False)
        Catch ex As Exception
    ...
    Protected Sub gvProcessList_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs)
        ...
        Try
            ...
            Dim cbHalfSplit As CheckBox
            Dim txtCurrentQtyShftsPerDay As TextBox

            ''***
            ''This section allows the inserting of a new row when called by the OnInserting event call.
            ''***
            If (e.CommandName = "Insert") Then
                txtProcessTemp = CType(gvProcessList.FooterRow.FindControl("txtMFGProcessNameGVF"), TextBox)
                odsProcessList.InsertParameters("MFGProcessName").DefaultValue = txtProcessTemp.Text

                cbHalfSplit = CType(gvProcessList.FooterRow.FindControl("cbHalfSplitGVF"), CheckBox)
                odsProcessList.InsertParameters("HalfSplit").DefaultValue = cbHalfSplit.Checked

                txtCurrentQtyShftsPerDay = CType(gvProcessList.FooterRow.FindControl("txtCurrentQtyShftsPerDayGVF"), TextBox)
                odsProcessList.InsertParameters("CurrentQtyShftsPerDay").DefaultValue = txtCurrentQtyShftsPerDay.Text
            ...
            If e.CommandName = "Undo" Then
                txtProcessTemp = CType(gvProcessList.FooterRow.FindControl("txtMFGProcessNameGVF"), TextBox)
                txtProcessTemp.Text = Nothing

                cbHalfSplit = CType(gvProcessList.FooterRow.FindControl("cbHalfSplitGVF"), CheckBox)
                cbHalfSplit.Checked = Nothing

                txtCurrentQtyShftsPerDay = CType(gvProcessList.FooterRow.FindControl("txtCurrentQtyShftsPerDayGVF"), TextBox)
                txtCurrentQtyShftsPerDay.Text = Nothing
...
#Region "Insert Empty GridView Work-Around"
    ...
    Protected Sub odsReasonList_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles odsProcessList.Selected
        ...
        Try
            ...
            Dim dt As MfgProd.MFG_Capacity_ProcessDataTable = CType(e.ReturnValue, MfgProd.MFG_Capacity_ProcessDataTable)
