// ************************************************************************************************
// Name:	calendar.js
// Purpose:	This java code is used to help build the calendar.html page with American date format.
//
// Date		        Author	    
// 12/06/2007       LRey			Created .Net application
// ************************************************************************************************ 
...
function cal_popup2 (str_datetime) {
	...
	var obj_calwindow = window.open(
		'../html/calendar.html?id=' + this.id + '&s=' + this.dt_selected.valueOf() + '&c=' + this.dt_current.valueOf(),
		'Calendar', 'width=200,height=' + (this.time_comp ? 215 : 190) +
		',status=no,resizable=no,top=200,left=200,dependent=yes,alwaysRaised=yes,menubar=0'
	);
